...
resource "aws_api_gateway_method_response" "create_root_login_profile_options" {
  rest_api_id = aws_api_gateway_rest_api.root_access_api.id
  resource_id = aws_api_gateway_resource.create_root_login_profile_account.id
  http_method = aws_api_gateway_method.create_root_login_profile_options.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "create_root_login_profile_options" {
  rest_api_id = aws_api_gateway_rest_api.root_access_api.id
  resource_id = aws_api_gateway_resource.create_root_login_profile_account.id
  http_method = aws_api_gateway_method.create_root_login_profile_options.http_method
  status_code = aws_api_gateway_method_response.create_root_login_profile_options.status_code
  ...
  depends_on = [aws_api_gateway_integration.create_root_login_profile_options]
}