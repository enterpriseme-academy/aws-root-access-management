...
function getBucketPolicy() {
    ...
    .then(data => {
        const output = document.getElementById('policyOutput').querySelector('code');
...
document.getElementById('getPolicyButton').addEventListener('click', getBucketPolicy);
document.getElementById('deletePolicyButton').addEventListener('click', deleteBucketPolicy);
document.getElementById('deleteRootAccountButton').addEventListener('click', deleteRootAccount);
document.getElementById('createRootAccountButton').addEventListener('click', createRootAccount);